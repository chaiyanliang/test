...
use app\portal\service\ProjectService;
use app\portal\model\PortalCategoryModel;
use app\portal\service\CourtService;
use think\Db;
use app\admin\model\ThemeModel;
use app\portal\model\AuctionPlatformModel;
...
class AdminProjectController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $data        = $ProjectService->adminArticleList($param);
    ...
    public function add()
    {
        ...
        $platform=new AuctionPlatformModel();        
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $AuctionProjectModel->adminAddArticle($data['post'], $data['post']['categories']);

            $data['post']['id'] = $AuctionProjectModel->id;
            $hookParam          = [
                'is_add'  => true,
                'article' => $data['post']
            ];
            ...
            $this->success('添加成功!', url('AdminProject/edit', ['id' => $AuctionProjectModel->id]));
    ...
    public function edit()
    {
        ...
        $AuctionProjectModel = new AuctionProjectModel();
        $post            = $AuctionProjectModel->where('id', $id)->find();
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $AuctionProjectModel->adminEditArticle($data['post'], $data['post']['categories']);
    ...
    public function delete()
    {
        ...
        if (isset($param['id'])) {
            $id           = $this->request->param('id', 0, 'intval');
            $result       = $AuctionProjectModel->where(['id' => $id])->find();
            $data         = [
                'object_id'   => $result['id'],
                'create_time' => time(),
            ...
            $resultPortal = $AuctionProjectModel
                ->where(['id' => $id])
        ...
        if (isset($param['ids'])) {
            ...
            $recycle = $AuctionProjectModel->where(['id' => ['in', $ids]])->select();
            $result  = $AuctionProjectModel->where(['id' => ['in', $ids]])->update(['delete_time' => time()]);
            if ($result) {
    ...
    public function publish()
    {
        ...
        if (isset($param['ids']) && isset($param["yes"])) {
            ...
            $AuctionProjectModel->where(['id' => ['in', $ids]])->update(['post_status' => 1, 'published_time' => time()]);
        ...
        if (isset($param['ids']) && isset($param["no"])) {
            ...
            $AuctionProjectModel->where(['id' => ['in', $ids]])->update(['post_status' => 0]);
    ...
    public function top()
    {
        ...
        if (isset($param['ids']) && isset($param["yes"])) {
            ...
            $AuctionProjectModel->where(['id' => ['in', $ids]])->update(['is_top' => 1]);
        ...
        if (isset($_POST['ids']) && isset($param["no"])) {
            ...
            $AuctionProjectModel->where(['id' => ['in', $ids]])->update(['is_top' => 0]);
    ...
    public function recommend()
    {
        ...
        if (isset($param['ids']) && isset($param["yes"])) {
            ...
            $AuctionProjectModel->where(['id' => ['in', $ids]])->update(['recommended' => 1]);
        ...
        if (isset($param['ids']) && isset($param["no"])) {
            ...
            $AuctionProjectModel->where(['id' => ['in', $ids]])->update(['recommended' => 0]);
