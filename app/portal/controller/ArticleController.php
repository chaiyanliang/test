...
class ArticleController extends HomeBaseController
{
    public function index()
    {
        ...
        $article    = $ProjectService->publishedArticle($articleId, $categoryId);
        ...
        $prevArticle = $ProjectService->publishedPrevArticle($articleId, $categoryId);
        $nextArticle = $ProjectService->publishedNextArticle($articleId, $categoryId);
        ...
        Db::name('auction_project')->where(['id' => $articleId])->setInc('post_hits');
